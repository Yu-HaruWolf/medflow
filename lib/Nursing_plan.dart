...
class _Planing extends State<Nursing_plan> with SingleTickerProviderStateMixin {
  ...
  final TextEditingController _contactRelationController = TextEditingController();
...
Widget _buildScrollableTabContent(String tabName) {
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        _buildInputField('Subjective Data', _sController, 'Enter subjective information'),
        _buildInputField('Objective Data', _oController, 'Enter objective information'),
        _buildInputField('Assessment', _aController, 'Enter assessment information'),
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        _buildInputField('Date of Birth', _birthController, 'e.g., 1990/01/01'),
        _buildInputField('Current Address', _addressController, 'e.g., Shinjuku, Tokyo...'),
        _buildInputField('Phone Number', _phoneController, 'e.g., 090-1234-5678'),
        _buildInputField('Diagnosis', _diagnosisController, 'e.g., Hypertension'),
        _buildInputField('Date of Admission', _admissionDateController, 'e.g., 2025/04/01'),
        _buildInputField('Emergency Contact (Name)', _contactNameController, 'e.g., Hanako Yamada'),
        _buildInputField('Emergency Contact (Relationship)', _contactRelationController, 'e.g., Wife'),
        _buildInputField('Emergency Contact (Phone Number)', _contactPhoneController, 'e.g., 090-9876-5432'),
        ...
        ElevatedButton(
          onPressed: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('個人情報を保存しました')),
            );
          },
          child: Text('Save'),
        ),
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        const Text('Perception of Diagnosis', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        buildDropdownField(
          label: 'Meals',
          items: ['Can eat independently', 'Can eat with assistive devices', 'Can eat with setup', 'Cannot eat independently'],
        ...
        buildDropdownField(
          label: 'Bathing',
          items: ['Can bathe independently', 'Can take a shower independently', 'Cannot bathe independently'],
        ...
        buildDropdownField(
          label: 'Dressing',
          items: ['Can do everything independently', 'Can put on/take off upper garments', 'Can put on/take off pants', 'Can dress/undress except buttons/hooks', 'Cannot dress/undress independently'],
        ...
        buildDropdownField(
          label: 'Grooming',
          items: ['Can do everything independently', 'Can wash face', 'Can comb hair', 'Cannot groom independently'],
        ...
        buildDropdownField(
          label: 'Toileting',
          items: ['Can use toilet independently', 'Can use portable toilet', 'Can use bedpan/urinal independently', 'Cannot perform toileting independently'],
        ...
        buildDropdownField(
          label: 'Bed Mobility',
          items: ['Can move freely in bed', 'Can sit up', 'Can sit up with support', 'Can turn over', 'Can turn over with support', 'Cannot move independently'],
        ...
        buildDropdownField(
          label: 'Transfers',
          items: ['Can move freely', 'Can transfer with devices', 'Requires supervision', 'Requires partial assistance', 'Fully dependent', 'Makes no attempt to move'],
        ...
        buildDropdownField(
          ...
          items: ['Can transfer independently', 'Cannot transfer independently'],
        ...
        buildDropdownField(
          label: 'Walking',
          items: ['Can walk', 'Can walk with cane/walker', 'Can walk holding on to something', 'Cannot walk', 'Makes no attempt to walk'],
